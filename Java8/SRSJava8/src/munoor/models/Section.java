...
//------------
    ...
    // Accessor methods.
    //------------------
    public final void setSectionNo(int no) {
        sectionNo = no;
    }
    ...
    public final void setDayOfWeek(char day) {
        dayOfWeek = day;
    }
    ...
    public final void setTimeOfDay(String time) {
        timeOfDay = time;
    }
    ...
    public final void setInstructor(Professor prof) {
        instructor = prof;
    }
    ...
    public final void setRepresentedCourse(Course c) {
        representedCourse = c;
    }
    ...
    public final void setRoom(String r) {
        room = r;
    }
    ...
    public final void setSeatingCapacity(int c) {
        seatingCapacity = c;
    }
    ...
    public final void setOfferedIn(ScheduleOfClasses soc) {
        offeredIn = soc;
    }
